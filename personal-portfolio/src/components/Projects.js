...
export const Projects = () => {
  const projects = [
    ...
    },
    {
      ...
      description:
        "The battleship game is a mobile game designed using Android Studio and Java. The battleship will fire bullets when you touch the upper screen and drop depth charges when touching the bottom screen. ",
      imgUrl: projImg2,
    ...
    },
    {
      ...
      description:
        "Job-Seeker App is made by React Native. It shows the popular jobs and the nearby jobs from the home page.",
      imgUrl: projImg3,
    ...
    },
    {
      ...
      description:
        "BYU Job Seeker is a Node.js project that allows the students at BYU to find their desired on-campus jobs by selecting the departments and job categories.",
      imgUrl: projImg4,
    ...
    },
    {
      title: "BYUH Holokai",
      description:
        "Holokai is a Mendix project for BYU Hawaii. Holokai Program is BYU-Hawaii's academic program. It allows the students to choose one major and two minors/certificates from three different categories",
      imgUrl: projImg5,
    ...
    },
    {
      title: "Personal Blog",
      description:
        "This project is created by React JS. The users can click the blog on the home page to view the blog detail. They can also create a new blog and delete the existing blogs if they wish.",
      imgUrl: projImg6,
    ...
    },
    {
      title: "Flower Power",
      description:
        "Flower Power is a Java project. The Program will ask the players random math questions. If the players answer correctly, a flower will appear in the garden.",
      imgUrl: projImg7,
    ...
    },
    {
      title: "To-DO List",
      description:
        "Todo-List Project is a simple web project created by JavaScript, HTML, and CSS. The user can create a new task, delete the tasks, and filter the completed tasks.",
      imgUrl: projImg8,
    ...
    },
    {
      title: "Filter Image",
      description:
        "Filter-Image Project is an HTML, CSS, and JavaScript project that allows users to filter images from three categories: phones, clothes, and shoes, using the filter button or search bar. When you click the image, the detailed information will appear in a pop-up window.",
      imgUrl: projImg9,
    ...
    },
    {
      ...
      description:
        "This project is written by PLC Programming Language. The arm will grab the materials from one side and place them on the other side. The arm will perform different actions based on different materials (plastics or glasses).",
      imgUrl: projImg10,
        ...
        <Row>
          <Col size={12}>
            <div>
              <h2>Projects</h2>
              <p>
                I am also passionate about exploring new technologies in my free
                time, having worked on various exciting projects using
                programming languages and frameworks such as React Native,
